...
`)},G=(t={})=>r=>{r.env.isDebug&&D.info("Options:",t);const a=(e,o=[])=>{const s=!!t[e],m=o.every(i=>P(i,!!t[e]));return s&&m},n={chartjs:a("chartjs",["chart.js"]),echarts:a("echarts",["echarts"]),flowchart:a("flowchart",["flowchart.ts"]),markmap:a("markmap",["markmap-lib","markmap-toolbar","markmap-view"]),mermaid:a("mermaid",["mermaid"])};return{name:x,extendsMarkdown:e=>{n.chartjs&&e.use(g),n.echarts&&e.use(C),n.flowchart&&e.use(M),J(t.plantuml)?e.use($,t):t.plantuml&&e.use($),n.markmap&&e.use(b),n.mermaid&&e.use(S)},extendsBundlerOptions:e=>{I(e,r,["@vuepress/helper","fflate"]),n.chartjs&&(h(e,r,"chart.js/auto/auto.mjs"),p(e,r,"chart.js")),n.echarts&&(h(e,r,"echarts"),p(e,r,"echarts")),n.flowchart&&(h(e,r,"flowchart.ts"),p(e,r,"flowchart.ts")),n.markmap&&(q(e,r,["markmap-lib","markmap-toolbar","markmap-view"]),p(e,r,["markmap-lib","markmap-toolbar","markmap-view"])),n.mermaid&&(h(e,r,"mermaid/dist/mermaid.esm.min.mjs"),p(e,r,"mermaid"))},clientConfigFile:()=>z(r,n)}};export{g as chartjs,C as echarts,M as flowchart,v as getMermaidContent,G as markdownChartPlugin,b as markmap,S as mermaid,$ as plantuml};
